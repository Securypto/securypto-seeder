...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Securypto-seeder\n"
...
static const string mainnet_seeds[] = {"127.0.0.1", "168.235.103.70", "45.147.229.232", "213.227.154.211", ""};
static const string testnet_seeds[] = {"127.0.0.1", "168.235.103.70", "45.147.229.232", "213.227.154.211", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("45.147.229.232", 19997), true);
  }
  do {
